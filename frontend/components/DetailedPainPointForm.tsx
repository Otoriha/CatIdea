...
const TAG_SUGGESTIONS = [
  // 技術領域
  'フロントエンド', 'バックエンド', 'インフラ', 'モバイル', 'デスクトップ',
  'React', 'Vue', 'Angular', 'Next.js', 'Rails', 'Django', 'Laravel',
  'Docker', 'Kubernetes', 'AWS', 'GCP', 'Azure',
  // 問題の性質
  'パフォーマンス', 'セキュリティ', 'UX', 'DX', 'アクセシビリティ',
  'バグ', '機能不足', '学習コスト', '運用負荷', '技術的負債',
  // 影響範囲
  '個人開発', 'チーム開発', 'OSS', '仕事', '副業', 'スタートアップ',
  // 一般的なカテゴリ
  '認証', 'API', 'データベース', 'キャッシュ', 'テスト', 'CI/CD',
  '効率化', '自動化', 'ドキュメント', 'コミュニケーション'
]
